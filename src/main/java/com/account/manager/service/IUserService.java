...
public interface IUserService {
  ...
  /**
   * Returns a user speficied by id Throws NotFoundException if user does not
   * exist
   */
  ...
  /**
   * Edits an existing user Throws NotFoundException if the user does not exist
   */
  User editUser(int id, User data) throws NotFoundException;

  /**
   * Deletes a user Throws NotFoundExeption if the user does not exist
   */
